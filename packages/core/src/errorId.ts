import { getAppId, isWxMiniEnv, variableTypeDetection } from 'front-monitor-utils';
import { ErrorTypes, EventTypes } from 'front-monitor-shared';
...
// 将上述errorId拼接的字符串转为hash，如： -1011882033
