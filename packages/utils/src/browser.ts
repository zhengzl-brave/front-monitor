import { EventTypes, ErrorTypes, WxAppEvents, WxPageEvents } from 'front-monitor-shared';
import { getLocationHref, getTimestamp } from './helpers';
import { setFlag } from './global';
import { ReportDataType, InitOptions } from 'front-monitor-types';
import { Severity } from './severity';

// 返回包含 id、class、innerText 的字符串标签
