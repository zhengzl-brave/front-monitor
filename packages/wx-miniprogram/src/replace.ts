...
import { MonitorHttp, EMethods } from 'front-monitor-types';
        ...
        replaceOld(
          ...
          function (originMethod: voidFun) {
            return function (...args: any): void {
              ...
              triggerHandler.apply(null, [method, ...args]);
            };
          },
          true,
        );
...
function replaceAction(
  ...
  function gestureTrigger(e) {
    ...
    triggerHandler(EventTypes.DOM, e);
  }
    ...
    Object.defineProperty(wx, hook, {
      ...
      value: function (...args: any[]) {
        ...
        const successHandler:
          ...
          triggerHandler(EventTypes.XHR, data);
  ...
  methods.forEach((method) => {
    ...
    Object.defineProperty(wx, method, {
      ...
      value: function (
        ...
        triggerHandler(EventTypes.MINI_ROUTE, data);
        ...
        if (
          ...
          const failHandler:
            ...
            triggerHandler(EventTypes.MINI_ROUTE, failData);
            if (variableTypeDetection.isFunction(_fail)) {
              return _fail(res);
            }
          };
